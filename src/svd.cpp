...
SVD::SVD(double** A, int rows, int cols)
{
    ...
    /*
      ...
      * let's not throw error. Correct fix to come later? if (m<n) { throw new
...
double SVD::hypot(double a, double b)
{
