...
VecPosition VecPosition::givePosition(VecPosition start,  double angle,  double distance)
{
    VecPosition end  = start + VecPosition(distance,angle,POLAR);
    return end;
}
...
bool Triangle::isInside(VecPosition pos){
    bool b1, b2, b3;

     b1 = sign(pos, p1, p2) < 0.0f;
     b2 = sign(pos, p2, p3) < 0.0f;
     b3 = sign(pos, p3, p1) < 0.0f;
